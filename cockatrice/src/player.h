...
private:
    ...
    void eventCreateZone(const Event_CreateZone &event);
    void eventDestroyZone(const Event_DestroyZone &event);
    ...
    void eventAttachZone(const Event_AttachZone &event);
