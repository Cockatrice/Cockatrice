      ...
      cardSizeSlider(_cardSizeSlider), rootCard(_rootCard)
{
    ...
    connect(this, &PrintingSelectorCardOverlayWidget::cardPreferenceChanged, this, &PrintingSelectorCardOverlayWidget::updatePinBadgeVisibility);
