...
QString QtLocalPeer::appSessionId(const QString &appId)
{
    ...
    //### could do: two 16bit checksums over separate halves of id, for a 32bit result - improved uniqeness probability.
    //Every-other-char split would be best.
...
{
    if (id.isEmpty())
        id = QCoreApplication::applicationFilePath(); //### On win, check if this returns .../argv[0] without
                                                      //casefolding; .\MYAPP == .\myapp on Win
