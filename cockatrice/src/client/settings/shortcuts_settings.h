...
private:
    ...
    const QHash<QString, ShortcutKey> defaultShortCuts = {
        ...
        {"Player/aViewBottomCards", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Bottom Cards of Library"),
                                                ...
                                                ShortcutGroup::View)},
        {"Player/aAddCommanderTax", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Increase 1st Tax"),
                                                parseSequenceString(""),
                                                ShortcutGroup::Player_Counters)},
        {"Player/aRemoveCommanderTax", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Decrease 1st Tax"),
                                                   parseSequenceString(""),
                                                   ShortcutGroup::Player_Counters)},
        {"Player/aAddPartnerTax", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Increase 2nd Tax"),
                                              parseSequenceString(""),
                                              ShortcutGroup::Player_Counters)},
        {"Player/aRemovePartnerTax", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Decrease 2nd Tax"),
                                                 parseSequenceString(""),
                                                 ShortcutGroup::Player_Counters)},
