...
private:
    ...
    const QHash<QString, ShortcutKey> defaultShortCuts = {
        ...
        {"Player/aViewBottomCards", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Bottom Cards of Library"),
                                                ...
                                                ShortcutGroup::View)},
        {"Player/aIncrease1stCastCount", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Increase 1st Cast Count"),
                                                     parseSequenceString(""),
                                                     ShortcutGroup::Player_Counters)},
        {"Player/aDecrease1stCastCount", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Decrease 1st Cast Count"),
                                                     parseSequenceString(""),
                                                     ShortcutGroup::Player_Counters)},
        {"Player/aIncrease2ndCastCount", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Increase 2nd Cast Count"),
                                                     parseSequenceString(""),
                                                     ShortcutGroup::Player_Counters)},
        {"Player/aDecrease2ndCastCount", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Decrease 2nd Cast Count"),
                                                     parseSequenceString(""),
                                                     ShortcutGroup::Player_Counters)},
