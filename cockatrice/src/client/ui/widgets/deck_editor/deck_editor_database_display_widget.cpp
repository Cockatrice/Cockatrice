    ...
    : QWidget(parent), deckEditor(_deckEditor)
{
    ...
    connect(databaseView, SIGNAL(doubleClicked(const QModelIndex &)), deckEditor, SLOT(actAddCard()));
    ...
    connect(aAddCardToSideboard, SIGNAL(triggered()), deckEditor, SLOT(actAddCardToSideboard()));
