...
DlgRollDice::DlgRollDice(QWidget *parent) : QDialog(parent)
{
    ...
    numberOfSidesEdit->setValidator(
        new QIntValidator(Server_Player::MINIMUM_DIE_SIDES, Server_Player::MAXIMUM_DIE_SIDES, numberOfSidesEdit));
    ...
    numberOfDiceEdit->setValidator(
        new QIntValidator(Server_Player::MINIMUM_DICE_TO_ROLL, Server_Player::MAXIMUM_DICE_TO_ROLL, numberOfDiceEdit));
